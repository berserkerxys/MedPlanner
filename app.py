...
def tela_login():
    ...
    with c2:
        ...
        t1, t2 = st.tabs(["Acesso", "Novo Registro"])
        with t1:
    ...
    if status:
        ...
        with c2:
            with st.container(border=True):
                ...
                st.progress(status['xp_atual']/1000, text="Progresso para próximo nível")
