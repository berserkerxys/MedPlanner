...
<style>
    ...
    .stTabs [data-baseweb="tab"] { font-size: 14px; font-weight: 600; padding: 0.5rem 1rem; }
...
try:
    ...
    from banco_questoes import render_banco_questoes # Nova Importação
...
def app_principal():
    try:
        ...
        with abas[2]: render_banco_questoes(None) # Nova aba
